...
//Upload folder
$config["uploadFolder"] = PDOCrudABSPATH . $_ENV['UPLOAD_FOLDER'];
//Upload folder URL
//$config["uploadURL"] = $config["script_url"] . "script/uploads/";
//$config["uploadURL"] = "";
//download folder
//echo $config["downloadFolder"] = PDOCrudABSPATH . "downloads/";
//Download folder URL
//$config["downloadURL"] = $config["script_url"] . "/app/script/downloads/";
