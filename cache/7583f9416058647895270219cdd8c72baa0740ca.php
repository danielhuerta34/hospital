...
<script>
	$(document).on("click", ".popup", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(base_url); ?>/home/paciente",
			data: {
				id: id
			},
			beforeSend: function() {
	...
	$('.liberar_consultas').click(function() {
		Swal.fire({
			...
			if (result.isConfirmed) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo e(base_url); ?>/home/liberar_consultas",
					dataType: "json",
					success: function(data) {
	...
	$(document).on("change", ".seleccion_estado", function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo e(base_url); ?>/home/obtener_pacientes_atendidos",
			dataType: "json",
			data: {
				valor: id_consulta
			},
...
</script><?php /**PATH D:\xampp74\htdocs\hospital\app\views/home.blade.php ENDPATH**/ ?>